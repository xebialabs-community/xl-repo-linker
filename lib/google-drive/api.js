                ...
                if (_.isEmpty(_.find(res.items, 'role', 'reader'))) {
                    ...
                    drive.permissions.insert({
                        ...
                        if (err) {
                            ...
                            XlreSharedApi.saveSharedLink(foundFile.webContentLink, fileName, userInfo.name).then(function (document) {
...
XlreApi.prototype.downloadFile = function (auth) {
    ...
    XlreApi.prototype.findFile(fileToDownload.title, auth) //TODO: instead of this now download file with webContentLink taken from mongolab
