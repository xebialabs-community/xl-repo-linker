                    ...
                    drive.permissions.insert({
                        ...
                        if (err) {
                            ...
                            XlreSharedApi.findSnapshotByName(fileName).then(function () {
                                return XlreSharedApi.updateSharedLink(foundFile.webContentLink, fileName, userInfo.name);
                            }).fail(function () {
                                return XlreSharedApi.saveSharedLink(foundFile.webContentLink, fileName, userInfo.name)
