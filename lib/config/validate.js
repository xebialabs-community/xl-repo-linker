...
XlreConfigValidate.prototype.checkConfig = function (options, mode, deferred) {
    ...
    XlreConfigValidate.prototype.checkXldLicense(options, deferred);
...
XlreConfigValidate.prototype.checkXldLicense = function (options, deferred) {
    var xldLicensePath = XlreConfig.getKeyValue('xld.license');

    if (options.checkXldLicense) {
        if (!xldLicensePath) {
            deferred.reject({
